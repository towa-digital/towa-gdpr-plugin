...
function () {
  ...
  _createClass(TowaGdprCookie, [{
    ...
    value: function defineObservables() {
      ...
      this.state.active = new _observable__WEBPACK_IMPORTED_MODULE_10__["default"](this.state.active, this.ref.domEl), this.ref.domEls.forEach(function (domEl) {
...
function (_TowaGdprCookie) {
  ...
  function EssentialCookie(cookie, root) {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(EssentialCookie).call(this, cookie, root));
  }
...
function () {
  function CookieGroup(group, root, display) {
    ...
    this.ref = {
      ...
      panelMobile: root.querySelector("#".concat(this.state.id, "-mobile"))
    };
  ...
  _createClass(CookieGroup, [{
    key: "getCookies",
    value: function getCookies(group, root) {
      if (group.cookies instanceof Object) {
        this.state.cookies = group.cookies.map(function (cookie) {
          return new _cookie__WEBPACK_IMPORTED_MODULE_1__["default"](cookie, root);
        });
      }
    }
  }, {
    ...
    key: "defineObservables",
    value: function defineObservables() {
      this.state.display = new _observable__WEBPACK_IMPORTED_MODULE_2__["default"](this.state.display, this.ref.domEl);
    ...
    value: function render() {
      this.ref.domEl.checked = this.state.active.value;
      Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["setCssClass"])(this.ref.panel, 'active', this.state.display.value);
      Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["setCssClass"])(this.ref.panelMobile, 'active', this.state.display.value);
      Object(_helpers__WEBPACK_IMPORTED_MODULE_3__["setCssClass"])(this.ref.li, 'active', this.state.display.value);
    }
  }, {
    key: "toggle",
    value: function toggle() {
      ...
      this.state.cookies.forEach(function (cookie) {
        cookie.setActive(_this.state.active.value, false);
      });
    }
  }, {
    key: "setUpListeners",
    value: function setUpListeners() {
      ...
      this.ref.root.addEventListener('cookieChanged', function () {
        _this2.state.active.value = _this2.isGroupActive();
      });
      this.ref.li.addEventListener('click', function () {
        _this2.ref.root.dispatchEvent(_this2.toggleGroupClickedEvent, _this2.state.id);

        _this2.state.display.value = true;
      });
      this.ref.root.addEventListener('toggleGroupClicked', function (event) {
        if (_this2.state.id !== event.detail.id) {
          _this2.state.display.value = false;
        }
      });
    }
  }, {
...
function (_CookieGroup) {
  ...
  function EssentialCookieGroup(group, root, display) {
    _classCallCheck(this, EssentialCookieGroup);

    return _possibleConstructorReturn(this, _getPrototypeOf(EssentialCookieGroup).call(this, group, root, display));
  }
  ...
  _createClass(EssentialCookieGroup, [{
    ...
    value: function getCookies(group, root) {
      if (group.cookies instanceof Object) {
        this.state.cookies = group.cookies.map(function (cookie) {
          return new _cookieEssential__WEBPACK_IMPORTED_MODULE_4__["default"](cookie, root);
        });
      }
    }
  }, {
...
/* harmony import */ var _cookiegroup__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./cookiegroup */ "./src/js/cookiegroup.js");
/* harmony import */ var _observable__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./observable */ "./src/js/observable.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./helpers */ "./src/js/helpers.js");
/* harmony import */ var _cookiegroupEssential__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./cookiegroupEssential */ "./src/js/cookiegroupEssential.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
function () {
  function TowaGdprPlugin() {
    ...
    if (this.context.settings.cookie_groups instanceof Object) {
      this.state.cookieGroups = this.context.settings.cookie_groups.map(function (group, index) {
        return new _cookiegroup__WEBPACK_IMPORTED_MODULE_2__["default"](group, _this.refs.root, index === 0);
      });
    }

    if (this.context.settings.essential_group instanceof Object) {
      var group = new _cookiegroupEssential__WEBPACK_IMPORTED_MODULE_5__["default"](this.context.settings.essential_group, this.refs.root, false);
  ...
  _createClass(TowaGdprPlugin, [{
    ...
    value: function defineObservables() {
      ...
      this.state.accepted = new _observable__WEBPACK_IMPORTED_MODULE_3__["default"](this.state.accepted, this.refs.root);
    ...
    key: "render",
    value: function render() {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["setCssClass"])(this.refs.root, 'show', !this.state.accepted.value);
    }
  }, {
    key: "applySettings",
    value: function applySettings() {
      if (this.context.settings.highlight_color) {
        var highlight_color_light = Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["convertHexColorToRgbString"])(this.context.settings.highlight_color, 0.1);
    ...
    value: function declineAll() {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["deleteAllCookies"])();
      this.state.cookieGroups.forEach(function (group) {
